...
<head>
  ...
  <title>SEkoLAH bersaMa (SEMA)</title>
...
<body>
  <script>
    ...
    defs["PredictResponse"] = {
      "type": "object",
      "properties": {
        "result": {
          "type": "number",
          "example": 88.02531433105469
        }
      }
    };
  </script>
      ...
      <div id="sidenav" class="span2">
        <nav id="scrollingNav">
          <ul class="sidenav nav nav-list">
            ...
            <li class="nav-header" data-group="Predict"><a href="#api-Predict">API Methods - Predict</a></li>
            <li data-group="Predict" data-name="inputData" class="">
              <a href="#api-Predict-inputData">inputData</a>
            </li>
          </ul>
        </nav>
      </div>
      <div id="content">
        ...
        <div id="header">
          <div id="api-_">
            ...
            <hr>
            <div>
              <p>Key success factors for students is building effective communication between school parties, teachers,
                and parents. By building effective communication, it will create a strong understanding about the
                student itself between parents and teachers. One of ways to build strong and effective communication is
                by monitoring student progress and performance in school. But, unfortunately, monitoring student
                performance is just organized once in each semester by giving a report of each student's score in each
                semester. Due to this condition, building a platform for monitoring students' performance and progress
                will become an effective way to solve the problem. It will come up as an android app for monitoring
                student progress and performance. This apps will be able to track student progress, such as attendance,
                score prediction, and chat between teachers and parents. By tracking student progress, parents can
                discuss with their students and teachers about steps or decisions which need to be taken in order to
                improve their performance. So, that it can be a preventative step for parents to save their children
                from failing in class.</p>
              <p>Some useful links:</p>
              <ul>
                <li><a href="https://github.com/Nrulafind/SEMA">SEMA repository</a></li>
              </ul>
            </div>
          </div>
        </div>
        <div id="sections">
          <section id="api-Predict">
            <h1>Predict</h1>
            <div id="api-Predict-inputData">
              <article id="api-Predict-inputData-0" data-group="User" data-name="inputData" data-version="0">
                <div class="pull-left">
                  <h1>inputData</h1>
                  <p>Input (score) to run model</p>
                </div>
                <div class="pull-right"></div>
                <div class="clearfix"></div>
                <p></p>
                <p class="marked">Input [1,4] score to run model</p>
                <p></p>
                <br />
                <pre class="prettyprint language-html prettyprinted"
                  data-type="post"><code><span class="pln">/api/predict</span></code></pre>
                <p>
                <h3>Usage and SDK Samples</h3>
                </p>
                <ul class="nav nav-tabs nav-tabs-examples">
                  <li class="active"><a href="#examples-Predict-inputData-0-curl">Curl</a></li>
                  <li class=""><a href="#examples-Predict-inputData-0-java">Java</a></li>
                  <li class=""><a href="#examples-Predict-inputData-0-android">Android</a></li>
                  <!--<li class=""><a href="#examples-Predict-inputData-0-groovy">Groovy</a></li>-->
                  <li class=""><a href="#examples-Predict-inputData-0-objc">Obj-C</a></li>
                  <li class=""><a href="#examples-Predict-inputData-0-javascript">JavaScript</a></li>
                  <!--<li class=""><a href="#examples-Predict-inputData-0-angular">Angular</a></li>-->
                  <li class=""><a href="#examples-Predict-inputData-0-csharp">C#</a></li>
                  <li class=""><a href="#examples-Predict-inputData-0-php">PHP</a></li>
                  <li class=""><a href="#examples-Predict-inputData-0-perl">Perl</a></li>
                  <li class=""><a href="#examples-Predict-inputData-0-python">Python</a></li>
                </ul>

                <div class="tab-content">
                  <div class="tab-pane active" id="examples-Predict-inputData-0-curl">
                    <pre class="prettyprint"><code class="language-bsh">curl -X POST\
-H "Accept: application/json"\
-H "Content-Type: multipart/form-data"\
"https://backendsema-x6blq7wjaa-et.a.run.app//api/predict"</code></pre>
                  </div>
                  <div class="tab-pane" id="examples-Predict-inputData-0-java">
                    <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.PredictApi;

import java.io.File;
import java.util.*;

public class PredictApiExample {

    public static void main(String[] args) {
        
        PredictApi apiInstance = new PredictApi();
        array[BigDecimal] inputData = ; // array[BigDecimal] | 
        try {
            PredictResponse result = apiInstance.inputData(inputData);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling PredictApi#inputData");
            e.printStackTrace();
        }
    }
}</code></pre>
                  ...
                  <div class="tab-pane" id="examples-Predict-inputData-0-android">
                    <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.PredictApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                  ...
                  <!--
  <div class="tab-pane" id="examples-Predict-inputData-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                  <div class="tab-pane" id="examples-Predict-inputData-0-objc">
                    <pre class="prettyprint"><code class="language-cpp">array[BigDecimal] *inputData = ; //  (optional)

PredictApi *apiInstance = [[PredictApi alloc] init];

// Input (score) to run model
[apiInstance inputDataWith:inputData
              completionHandler: ^(PredictResponse output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                  ...
                  <div class="tab-pane" id="examples-Predict-inputData-0-javascript">
                    <pre class="prettyprint"><code class="language-js">var SEkoLahBersaMaSema = require('s_eko_lah_bersa_ma__sema');

var api = new SEkoLahBersaMaSema.PredictApi()
var opts = { 
  'inputData':  // {{array[BigDecimal]}} 
};
...
api.inputData(opts, callback);
</code></pre>
                  </div>

                  <!--<div class="tab-pane" id="examples-Predict-inputData-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                  <div class="tab-pane" id="examples-Predict-inputData-0-csharp">
...
namespace Example
{
    public class inputDataExample
    {
        public void main()
        {
            ...
            var apiInstance = new PredictApi();
            var inputData = new array[BigDecimal](); // array[BigDecimal] |  (optional) 
            ...
            {
                Debug.Print("Exception when calling PredictApi.inputData: " + e.Message );
            }
        }
    }
}
                  ...
                  <div class="tab-pane" id="examples-Predict-inputData-0-php">
                    <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\ApiPredictApi();
$inputData = ; // array[BigDecimal] | 

try {
    $result = $api_instance->inputData($inputData);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PredictApi->inputData: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                  </div>

                  <div class="tab-pane" id="examples-Predict-inputData-0-perl">
                    <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::PredictApi;

my $api_instance = WWW::SwaggerClient::PredictApi->new();
my $inputData = []; # array[BigDecimal] | 

eval { 
    my $result = $api_instance->inputData(inputData => $inputData);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling PredictApi->inputData: $@\n";
}</code></pre>
                  </div>

                  <div class="tab-pane" id="examples-Predict-inputData-0-python">
...
api_instance = swagger_client.PredictApi()
inputData =  # array[BigDecimal] |  (optional)

try: 
    # Input (score) to run model
    api_response = api_instance.input_data(inputData=inputData)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling PredictApi->inputData: %s\n" % e)</code></pre>
                  </div>
                </div>
                ...
                <table id="methodsubtable">
                  ...
                  <tr>
                    <td style="width:150px;">input_data</td>
                    <td>


                      <div id="d2e199_inputData_inputData">
                ...
                <h2>Responses</h2>
                <h3> Status: 200 - Successfully </h3>

                <ul class="nav nav-tabs nav-tabs-examples">
                  <li class="active">
                    <a data-toggle="tab" href="#responses-inputData-200-schema">Schema</a>
                  </li>

                </ul>

                <div class="tab-content" style='margin-bottom: 10px;'>
                  <div class="tab-pane active" id="responses-inputData-200-schema">
                    <div id='responses-inputData-200-schema-200'
                      style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                      <script>
    $(document).ready(function () {
      var schemaWrapper = {
      ...
      $('#responses-inputData-200-schema-data').val(stringify(schema));
      var result = $('#responses-inputData-200-schema-200');
      result.empty();
      result.append(view.render());
    });
                      </script>
                    </div>
                    <input id='responses-inputData-200-schema-data' type='hidden' value=''></input>
                  </div>
                </div>

                <h3> Status: 500 - Something went wrong </h3>
        ...
        <div id="footer">
          <div id="api-_footer">
            ...
            <div class="app-desc">Contact Info: <a href="sema-dev@gmail.com">sema-dev@gmail.com</a></div>
            </p>
  ...
  <script>
    (function (f) { if (typeof exports === "object" && typeof module !== "undefined") { module.exports = f() } else if (typeof define === "function" && define.amd) { define([], f) } else { var g; if (typeof window !== "undefined") { g = window } else if (typeof global !== "undefined") { g = global } else if (typeof self !== "undefined") { g = self } else { g = this } g.$RefParser = f() } })(function () {
      var define, module, exports; return (function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); var f = new Error("Cannot find module '" + o + "'"); throw f.code = "MODULE_NOT_FOUND", f } var l = n[o] = { exports: {} }; t[o][0].call(l.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, l, l.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
        1: [function (require, module, exports) {
          /** !
    ...
    (function () {
      ...
      function ra(a, b, d, c, e) {
        var f = 0 == --a.h; (a.f || a.g) && setTimeout(function () {
          var a = e || null, k = c || null || {}; if (0 === d.length && f) M(b.a); else {
            b.f += d.length; f && (b.j = f); var h, m = []; for (h = 0; h < d.length; h++) {
              var l = d[h], n = k[l.c], r = b.a, x = l; r.g && w(r.f, [r.a.c("wf", x.c, K(x).toString(), "loading")]); L(r, "fontloading", x); r = null; null === X && (X = window.FontFace ? (x = /Gecko.*Firefox\/(\d+)/.exec(window.navigator.userAgent)) ? 42 < parseInt(x[1], 10) : !0 : !1); X ? r = new Q(p(b.g, b), p(b.h, b), b.c, l, b.s, n) : r = new R(p(b.g, b), p(b.h, b), b.c, l, b.s, a,
                n); m.push(r)
            } for (h = 0; h < m.length; h++)m[h].start()
          }
        }, 0)
      } function qa(a, b, d) { var c = [], e = d.timeout; ia(b); var c = ka(a.a, d, a.c), f = new W(a.c, b, e); a.h = c.length; b = 0; for (d = c.length; b < d; b++)c[b].load(function (b, c, d) { ra(a, f, b, c, d) }) }; function sa(a, b) { this.c = a; this.a = b } function ta(a, b, d) { var c = z(a.c); a = (a.a.api || "fast.fonts.net/jsapi").replace(/^.*http(s?):(\/\/)?/, ""); return c + "//" + a + "/" + b + ".js" + (d ? "?v=" + d : "") }
      ...
      function Ea(a) {
        for (var b = a.f.length, d = 0; d < b; d++) {
          var c = a.f[d].split(":"), e = c[0].replace(/\+/g, " "), f = ["n4"]; if (2 <= c.length) {
            var g; var k = c[1]; g = []; if (k) for (var k = k.split(","), h = k.length, m = 0; m < h; m++) { var l; l = k[m]; if (l.match(/^[\w-]+$/)) { var n = Da.exec(l.toLowerCase()); if (null == n) l = ""; else { l = n[2]; l = null == l || "" == l ? "n" : Ca[l]; n = n[1]; if (null == n || "" == n) n = "4"; else var r = Ba[n], n = r ? r : isNaN(n) ? "4" : n.substr(0, 1); l = [l, n].join("") } } else l = ""; l && g.push(l) } 0 < g.length && (f = g); 3 == c.length && (c = c[2], g = [], c = c ? c.split(",") :
